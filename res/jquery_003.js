    ...
    a.flexslider = function(c, b) {
        ...
        d.init = function() {
            ...
            if (d.vars.directionNav) {
                var v = a('<div class="wrap-nav"><ul class="flex-direction-nav"><li><a class="prev" href="#">' + d.vars.prevText + '</a></li><li class="last"><a class="next" href="#">' + d.vars.nextText + "</a></li></ul></div>");
                if (d.containerExists) {
